...
n_complete_exclusions_expA = complete_exclusions_exp1 %>% filter(str_detect(unique_id, "A")) %>% nrow()
n_complete_exclusions_expB = complete_exclusions_exp1 %>% filter(str_detect(unique_id, "B")) %>% nrow()
n_complete_exclusions_expC = complete_exclusions_exp1 %>% filter(str_detect(unique_id, "C")) %>% nrow()

n_complete_exclusions_exp1 = n_complete_exclusions_expA + n_complete_exclusions_expB + n_complete_exclusions_expC
