...
\caption{\label{fig:infant-exp1-res}Experiment 1, infant results}
\end{figure}

\begin{figure}
\centering
\includegraphics{00_main_files/figure-latex/adult-exp1-res-1.pdf}
\caption{\label{fig:adult-exp1-res}Experiment 1, adult results}
\end{figure}
...
\caption{\label{fig:control-exp}Control experiment for experiment 2, checking for baseline differences in interest.}
\end{figure}

\hypertarget{test-123}{%
\section{test 123}\label{test-123}}
