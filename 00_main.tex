...
RANCH has a series of parameters: the learner's priors over the concept to be learned (\(\mu\), \(\sigma\)), the learner's priors over their perceptual noise (\(\epsilon\)) and the environmental EIG (\(EIG_{env}\)). We conducted an iterative grid search over these parameters.
